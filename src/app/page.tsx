  ...
  return (
    <MainLayout>
      <div className="flex flex-col min-h-screen bg-background">
        ...
        <main className="flex-1">
            <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 flex flex-col items-center text-center relative z-10">
              <div className="animate-fade-in-up">
                {/* Fixed height container for the title with typing effect */}
                <div className="min-h-[144px] md:min-h-[192px] flex items-center justify-center mb-8">
                  <h1 className="font-headline text-4xl md:text-6xl font-bold">
                    Master Any Subject with <div className='text-orange-300'>Excitement</div>
                  </h1>
                </div>
                
                {/* Separate container for the description */}
                <div className="mb-8">
                  <p className="text-lg md:text-xl text-muted-foreground max-w-3xl">
                    StudyCat uses AI to create perfectly personalized learning courses on any topic. Go from beginner to expert with a structured, easy-to-follow plan.
                  </p>
                </div>
        ...
        <footer className="bg-footer-background text-foreground relative z-10 opacity-95">
